...
<div class="box" id="login">
	<form:form method="post" id="fm1" commandName="${commandName}"
		...
		<div class="row fl-controls-left">
			<label for="authcode"><spring:message
					code="screen.welcome.label.authcode" /></label>
			<spring:message code="screen.welcome.label.authcode.accesskey"
				var="authcodeAccessKey" />
			<table>
				<tr>
					<td>
						<form:input cssClass="required" cssErrorClass="error"
							id="authcode" size="10" tabindex="2" path="authcode"
							accesskey="${authcodeAccessKey}" htmlEscape="true"
							autocomplete="off" />
					</td>
					<td align="left" valign="bottom" style="vertical-align: bottom;">
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<img alt="<spring:message code="required.authcode" />"
		...
		<section class="row btn-row">
			...
			<input type="hidden" name="_eventId" value="submit" /> <input
				...
				tabindex="6" type="submit" /> <input class="btn-reset" name="reset"
				accesskey="c"
